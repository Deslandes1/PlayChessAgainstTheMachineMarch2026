...
An interactive chess game where you play against an AI with move‑by‑move explanations. The dashboard helps you understand why each move is good or bad. Perfect for beginners learning chess tactics.
...
2. **Install dependencies** (automatic on Streamlit Cloud).
